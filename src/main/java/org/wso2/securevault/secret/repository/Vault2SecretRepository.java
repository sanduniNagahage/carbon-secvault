...
public class Vault2SecretRepository implements SecretRepository {
    ...
    public Vault2SecretRepository(IdentityKeyStoreWrapper identity, TrustKeyStoreWrapper trust) {
